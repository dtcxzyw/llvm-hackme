...
_TEST_KEYWORDS: list[tuple[str, str]] = [
    ...
    ("llvm/test/Transforms/DFAJumpThreading", "dfa-jump-threading"),
    ("llvm/test/Transforms/EarlyCSE", "early-cse"),
    ("llvm/test/Transforms/GVN", "gvn"),
    ("llvm/test/Transforms/JumpThreading", "jump-threading"),
...
_SOURCE_KEYWORDS: list[tuple[str, str]] = [
    ...
    (
        "llvm/lib/Transforms/Scalar/DFAJumpThreading",
        "dfa-jump-threading",
    ),
    ("llvm/lib/Transforms/Scalar/EarlyCSE", "early-cse"),
    ("llvm/lib/Transforms/Scalar/GVN", "gvn"),
    ("llvm/lib/Transforms/Scalar/JumpThreading", "jump-threading"),
