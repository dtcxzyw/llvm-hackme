...
def make_comment_body(
    ...
    *,
    ...
    if source is not None:
        source_desc = (
            "The reproducer was generated by a mutation-based fuzzer."
            if source == BugSource.FUZZER
            else "The reproducer was generated by LLM."
        )
        lines.extend(["", source_desc])
    if reproducer is not None:
        lines.extend(
            [
                "",
                "This bug is a regression introduced by this PR. "
                "It does not reproduce on the baseline commit.",
            ]
        )
    lines.append("")
