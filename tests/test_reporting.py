...
class TestCommentBody:
    ...
    def test_source_fuzzer(self) -> None:
        reproducer = Reproducer(
            kind=BugKind.CRASH,
            source_path=MagicMock(),
            command=["opt"],
        ...
        assert "generated by a mutation-based fuzzer" in body
    ...
    def test_source_agent(self) -> None:
        ...
        assert "generated by LLM" in body
    ...
    def test_source_none(self) -> None:
        ...
        assert "mutation-based fuzzer" not in body
        assert "generated by LLM" not in body
